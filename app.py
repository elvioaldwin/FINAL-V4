...
#def interpret_bmi(bmi):Fungsi ini menerima nilai BMI dan mengembalikan rekomendasi 
#kesehatan berdasarkan kategori BMI.
 #Output adalah tuple yang berisi:
    #- Kategori BMI
    #- Pesan motivasi
    #- Kode warna untuk UI
    #- Daftar aktivitas fisik yang disarankan beserta manfaatnya
    # Pesan motivasi tambahan#
...
def interpret_bmi(bmi):
 ...
 #Menampilkan informasi terkait BMI pengguna melalui aplikasi web yang menggunakan library Streamlit.
    #Fungsi ini memanfaatkan data dari fungsi interpret_bmi untuk menampilkan kategori BMI, saran, aktivitas disarankan,dan pesan motivasi.
    #Parameter:bmi (float): Nilai BMI yang akan ditampilkan informasinya.
    #Fungsi ini tidak mengembalikan nilai tetapi langsung menampilkan informasi ke antarmuka pengguna
...
#tabel BMI
    ...
    st.write('#### *untuk menggunakan aplikasi, klik tombol panah pada pojok kiri atas layar anda* ')
